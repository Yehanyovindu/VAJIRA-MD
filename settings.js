...
global.owner = process.env.OWNER_NUMBER  || '94773883257' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7JNikSDL#WoVOJ1zCSTzP06ya7Q6dXfMvcI-Ta8zvRKFb49BAvU4' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'HCKER-YOVI' ,
...
ANTI_CALL: process.env.ANTI_CALL || trye  ,
